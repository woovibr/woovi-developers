...
6. Um exemplo de comando é `composer require woovi/pix:2.4.0`. Acesse também a [documentação do Magento2](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/tutorials/extensions.html) para mais detalhes.