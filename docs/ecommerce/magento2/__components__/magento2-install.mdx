...
[Download Woovi Pix Magento2 Plugin - versão 2.5.2](pathname:///magento2/woovi_pix.2.5.2.zip) - Versão Atual
...
7. Um exemplo de comando para instalar o nosso plugin é `composer require woovi/pix`. Acesse também a [documentação do Magento2](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/tutorials/extensions.html) para mais detalhes.
