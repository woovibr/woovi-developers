...
- [ ] Cadastre um AppID do tipo API. Crie um appID [documentação de API](../../apis/api-getting-started.md)
...
- [ ] Cadastre a URL de Callback do WooCommerce na Woovi. Exemplo: [https://meusite.com.br/wc-api/WC_Woovi_Pix_Gateway](https://meusite.com.br/wc-api/WC_Woovi_Pix_Gateway)
