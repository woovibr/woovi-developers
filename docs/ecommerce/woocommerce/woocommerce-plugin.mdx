...
Você pode baixar o plugin diretamente pelo link abaixo:

[woocommerce-openpix-v2.13.4.zip](https://github.com/Open-Pix/woocommerce-openpix/releases/download/v2.13.4/woocommerce-openpix-prod-v2.13.4-2026-01-27.13.36.zip)

Para instalar o plugin baixado:
...
### Instalação via Repositório WordPress
...
### 2.1 Configuração Automática com Um Clique
