...
![Formulário de checkout com o CPF/CNPJ](./__assets__/opencart3/checkout-form-with-tax-id.png)

Após isso, o cliente deve selecionar _Pix_ como método de pagamento (_Payment Method_):

![Selecionando Pix como método de pagamento](./__assets__/opencart3/checkout-payment-method-selector.png)
...
![CPF/CNPJ durante o registro](./__assets__/opencart3/account-register-with-taxid.png)
...
![Configuração ou desativação do custom field](./__assets__/opencart3/admin-settings-custom-field.png)
...
![Campo CPF/CNPJ durante o checkout](./__assets__/opencart3/checkout-custom-field.png)
...
## Como configurar o título do método de pagamento Pix

Para modificar o título a ser empregado para o método de pagamento via Pix durante o processo de checkout, dirija-se à página de configurações da extensão.

Configure o título do método de pagamento no campo _Payment method title_ (Título do Método de Pagamento):

![Configuração do título do método de pagamento Pix](./__assets__/opencart3/admin-settings-pix-payment-method-title.png)
