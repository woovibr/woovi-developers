...
![Página da extensão com o botão de Download](./__assets__/opencart3/extension-download-page.png)
...
![Seleção do arquivo](./__assets__/opencart3/extension-file-selection.png)
...
![Botão para instalar a extensão](./__assets__/opencart3/install-extension-button.png)
...
![Instalação da extensão Woovi como método de pagamento](./__assets__/opencart3/install-payment-method.png)
...
![Página de logs da extensão](./__assets__/opencart3/admin-logs-page.png)
