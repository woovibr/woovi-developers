...
- **`name`**: O nome de identificação desse QRCode na plataforma Woovi.
...
```json
{
  "pixQrCode": {
    ...
    "paymentLinkUrl": "https://woovi.com/pay/1efcc519-3056-4a6c-94cd-d686969d8a61",
    "qrCodeImage": "https://api.woovi.com/openpix/charge/brcode/image/1efcc519-3056-4a6c-94cd-d686969d8a61.png"
  }
}
```
