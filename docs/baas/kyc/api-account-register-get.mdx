...
3. **Detecte a conclusão** — aguarde os webhooks do onboarding (veja [Como acompanhar o onboarding em tempo real por webhooks](./webhooks-ciclo-de-vida.mdx)) ou, em último caso, faça polling neste endpoint.
