 ...
 *         "paymentLinkUrl" => "https://woovi.com.br/pay/9134e286-6f71-427a-bf00-241681624586",
 ...
 * Exemplo de resultado:
 *
 * $result = "https://api.woovi.com.br/woovi/charge/brcode/image/7777-6f71-427a-bf00-241681624586.png?size=1024";
 */
```
...
class WebhookHandler
{
    ...
    public function __invoke()
    {
        ...
        if ($payload["event"] === self::woovi_CHARGE_COMPLETED) {
