...
title: Validando Webhook payload usando x-webhook-signature (Recomendado)
tags:
  - webhook
  - security
  - signature
...
# Como validar o Webhook Signature? (Recomendado)
...
[Buscando a chave pública da Woovi via API](./webhook-public-keys).
:::
