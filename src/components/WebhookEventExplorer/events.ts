...
const events: WebhookEvent[] = [
  ...
  {
    id: 'account-register-step-updated',
    event: 'ACCOUNT_REGISTER_STEP_UPDATED',
    category: 'Registro de conta',
    description:
      'Um passo do onboarding foi concluído pelo cliente final. O passo vem no payload, em step/stepScope/stepStatus.',
    docsPath: '/docs/baas/kyc/kyc-webhooks-lifecycle#account-register-step-updated',
    payload: {
      event: 'ACCOUNT_REGISTER_STEP_UPDATED',
      accountRegister: {
  ...
  {
    id: 'account-register-in-review',
    event: 'ACCOUNT_REGISTER_IN_REVIEW',
    category: 'Registro de conta',
    description:
      'O cadastro entrou em análise, seja pelo envio do cliente final, seja por um operador que o devolveu para revisão.',
    docsPath: '/docs/baas/kyc/kyc-webhooks-lifecycle#account-register-in-review',
    payload: {
      event: 'ACCOUNT_REGISTER_IN_REVIEW',
      accountRegister: {
        accountRegisterId: '66f0c2a1d4b2f10012ab34cd',
  ...
  {
    id: 'account-register-documents-requested',
    event: 'ACCOUNT_REGISTER_DOCUMENTS_REQUESTED',
    category: 'Registro de conta',
    description:
      'A análise pediu documentos novos (RFI) e lista quais passos voltaram a ficar pendentes.',
    docsPath: '/docs/baas/kyc/kyc-webhooks-lifecycle#account-register-documents-requested',
    payload: {
      event: 'ACCOUNT_REGISTER_DOCUMENTS_REQUESTED',
      accountRegister: {
        accountRegisterId: '66f0c2a1d4b2f10012ab34cd',
  ...
  {
    id: 'account-register-rfi-resolved',
    event: 'ACCOUNT_REGISTER_RFI_RESOLVED',
    category: 'Registro de conta',
    description:
      'O cliente final enviou todos os documentos pedidos e a RFI foi fechada.',
    docsPath: '/docs/baas/kyc/kyc-webhooks-lifecycle#account-register-rfi-resolved',
    payload: {
      event: 'ACCOUNT_REGISTER_RFI_RESOLVED',
      accountRegister: {
        accountRegisterId: '66f0c2a1d4b2f10012ab34cd',
