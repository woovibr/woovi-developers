---
id: magento1-plugin
title: Integrating Woovi with Magento1
...
This document details steps required to connect your Magento1 based e-Commerce platform to Woovi. The Woovi platform performs the reconciliation between your Bank and your e-Commerce in real time.
After connecting your Woovi account it is possible to charge customers in real time with QrCodes Pix, send Payment Links, manage charges including refunds.
...
[Download Woovi Magento1 Plugin - versão 2.1.0](pathname:///magento1/woovi_pix.2.1.0.zip) - Versão Atual
...
- **Webhook Authorization** Create a password for the Webhook integration. Webhook is required to update the status of Orders in real time when the Pix charge is paid.
  ...
  - Create a Webhook [here](#3-create-the-webhook-within-the-platform-woovi).
